...
本项目是基于 [isMobile](https://greasyfork.org/users/1131905-ismobile) 的开源项目 [超星学习通网课小助手](https://greasyfork.org/scripts/488083) 进行的深度改造，将原有的在线题库查询功能**完全替换**为本地部署的AI大模型自动答题。

### ✨ 主要特点

- ✅ **完全免费** - 无需购买题库VIP或任何付费服务
- ✅ **隐私保护** - 所有数据本地处理，不上传到任何服务器
- ✅ **离线使用** - 部署后无需联网即可答题
- ✅ **智能推理** - AI理解题目语义，而非简单查库
- ✅ **开源透明** - 代码完全开源，可自由修改和审查
- ✅ **支持繁体** - 自动识别繁体中文题型
